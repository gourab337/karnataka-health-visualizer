...
citation = Label(x=187.5-45, y=1880, x_units='screen', y_units='screen',
                 text='Less than 25%', render_mode='css',
                 border_line_color='black', border_line_alpha=1.0,
                 background_fill_color='#DC5039', background_fill_alpha=1.0)
q.add_layout(citation)
citation = Label(x=562.5-60, y=1880, x_units='screen', y_units='screen',
                 text='25% - 50%', render_mode='css',
                 border_line_color='black', border_line_alpha=1.0,
                 background_fill_color='#FFE945', background_fill_alpha=1.0)
q.add_layout(citation)
citation = Label(x=937.5-90, y=1880, x_units='screen', y_units='screen',
                 text='50% - 75%', render_mode='css',
                 border_line_color='black', border_line_alpha=1.0,
                 background_fill_color='#FD9F6C', background_fill_alpha=1.0)
q.add_layout(citation)
citation = Label(x=1312.5-130, y=1880, x_units='screen', y_units='screen',
                 text='Above 75%', render_mode='css',
                 border_line_color='black', border_line_alpha=1.0,
                 background_fill_color='#35B778', background_fill_alpha=1.0)
q.add_layout(citation)
#add text to color bar
...
temp = str(previousDate)
temp = temp.split(" ")
temp = temp[0].split("-")
temp = temp[::-1]
previousDate = "-".join(temp)


q.add_layout(Title(text="E-Sanjeevani HWC Telemedicine Status as on "+previousDate, text_font_size="34pt", align='center'), 'above')
